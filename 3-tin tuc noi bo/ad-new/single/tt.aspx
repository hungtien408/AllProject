<%@ Page Title="" Language="C#" MasterPageFile="~/ad-new/template/admin.master" AutoEventWireup="true"
    CodeFile="tt.aspx.cs" Inherits="ad_single_LocalArticle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <h3 class="mainTitle">
        <%--<img alt="" src="../assets/images/LocalArticle.png" class="vam" />--%>
        TIN TỨC NỘI BỘ
    </h3>
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchLocalArticleTitle" runat="server" Width="130px">
                        </asp:RadTextBox>
                    </td>
                    <td class="left">
                        Mô tả
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="LocalArticleID" SortExpression="LocalArticleID">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="LocalArticleTitle" HeaderText="Tiêu đề" SortExpression="LocalArticleTitle" />
                    <asp:GridBoundColumn DataField="LocalArticleCategoryName" HeaderText="Danh mục" SortExpression="LocalArticleCategoryName" />
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                <img alt="" src='<%# "~/res/LocalArticle/thumbs/" + Eval("ImageName") %>' width="80" runat="server"
                                    visible='<%# string.IsNullOrEmpty(Eval("ImageName").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("LocalArticleID") + "#" + Eval("ImageName") %>'
                            ...
                            <table class="search">
                                <tr>
                                    <td colspan="2" style="padding-left: 10px">
                                        <asp:HiddenField ID="hdnLocalArticleID" runat="server" Value='<%# Eval("LocalArticleID") %>' />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlCategory" runat="server" DataSourceID="ObjectDataSource2"
                                            DataTextField="LocalArticleCategoryName" DataValueField="LocalArticleCategoryID" Width="504px"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLocalArticleTitle" runat="server" Text='<%# Bind("LocalArticleTitle") %>'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtDescription" runat="server" Height="200" Language="vi-VN" Skin="Office2007"
                                            ...
                                            <ImageManager DeletePaths="~/Uploadstt/Image/" UploadPaths="~/Uploadstt/Image/" ViewPaths="~/Uploadstt/Image/" />
                                            <FlashManager DeletePaths="~/Uploadstt/Video/" UploadPaths="~/Uploadstt/Video/" ViewPaths="~/Uploadstt/Video/" />
                                            <DocumentManager DeletePaths="~/Uploadstt/File/" UploadPaths="~/Uploadstt/File/" ViewPaths="~/Uploadstt/File/" />
                                            <MediaManager DeletePaths="~/Uploadstt/Media/" UploadPaths="~/Uploadstt/Media/" ViewPaths="~/Uploadstt/Media/" />
                                            <TemplateManager DeletePaths="~/Uploadstt/Template/" UploadPaths="~/Uploadstt/Template/"
                                                ViewPaths="~/Uploadstt/Template/" />
                                            <Tools>
                                                <asp:EditorToolGroup>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Tiêu đề ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtLocalArticleTitle" />
                </TargetControls>
            </asp:TextBoxSetting>
        </asp:RadInputManager>
    </asp:RadAjaxPanel>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="LocalArticleSelectAll"
        TypeName="TTLib.LocalArticle" DeleteMethod="LocalArticleDelete" 
        UpdateMethod="LocalArticleUpdate" InsertMethod="LocalArticleInsert">
        <DeleteParameters>
            <asp:Parameter Name="LocalArticleID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchLocalArticleTitle" Name="LocalArticleTitle" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" Name="LocalArticleCategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="LocalArticleCategorySelectAll"
        TypeName="TTLib.LocalArticleCategory"></asp:ObjectDataSource>
