...
public partial class gio_hang : System.Web.UI.Page
{
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        ...
        //            MailAddress fromAddress = new MailAddress("webmaster@pet-house.com.vn");
        //            smtpClient.Host = "mail.pet-house.com.vn";
        //            smtpClient.Port = 25;
        //            message.From = fromAddress;

        //            //message.To.Add("info@avalgroups.com");
        //            message.To.Add("pet@pet-house.com.vn");
        //            //message.To.Add("nhatquangth@gmail.com");
        //            message.Subject = "NHÀ VẬT YÊU";
        ...
        //            string msg = "<h2>EMAIL FROM NHÀ VẬT YÊU</h2>";
        ...
        //            msg += "<b>Điện thoại: </b>" + txtHomePhone.Text.Trim().ToString() + "<br />";
        //            msg += "<b>ĐT di động: </b>" + txtCellPhone.Text.Trim().ToString() + "<br />";
        //            msg += "<b>Địa chỉ nhà: </b>" + txtHomeAddress.Text.Trim().ToString() + "<br />";
        ...
        //            msg += "<b>Địa chỉ nhận: </b>" + txtHomeAddress.Text.Trim().ToString() + "<br />";
        ...
        //            message.Body = msg;
        //            smtpClient.Credentials = new System.Net.NetworkCredential("webmaster@pet-house.com.vn", "P@ssword1");
