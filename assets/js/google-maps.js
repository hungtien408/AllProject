...
//Thay dia chi web
var endAddress = "10.770559, 106.692084";
//Thay toa do
var lat = 10.770559, long = 106.692084;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h2>Yuasa trading vietnam co.ltd</h2>' +
            '<div class="wrap-mapbox">' +
                '<p class="contact-1">Phòng 1007 lầu 10 tòa nhà Zen Plaza, Số 54 - 56 Nguyễn Trãi, Q.1. Tp.HCM</p>' +
                '<p class="contact-2">+84 3 925 1237 - 3 925 1238 &nbsp;&nbsp;&nbsp;&nbsp;  Fax: 84 8 3925 1239</p>' +
                '<p class="contact-3"><a class="link-mail" href="mailto:son.hoang@yuasa.com.vn">son.hoang@yuasa.com.vn</a> <a class="link-web" target="_blank" href="https://www.yuasa.vn">www.yuasa.vn</a></p>' +
            '</div>' +
        '</div>';
